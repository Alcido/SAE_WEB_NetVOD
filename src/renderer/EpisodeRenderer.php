    ...
    public function renderLong(): string {
        ...
        $html = <<<HTML
                ...
                <form action="?action=episode&episodeID={$this->video->id}" method="post">
                    ...
                    <div class="rating">
                        <input type="radio" id="num1" name="note" value="1"><label for="num1">1</label>
                        <input type="radio" id="num2" name="note" value="2"><label for="num2">2</label>
                        <input type="radio" id="num3" name="note" value="3"><label for="num3">3</label>
                        <input type="radio" id="num4" name="note" value="4"><label for="num4">4</label>
                        <input type="radio" id="num5" name="note" value="5"><label for="num5">5</label>
                    </div>
